...
## 1. 前提条件・事前準備
### 1.1 バージョン
このハンズオンの内容は、**Oracle Content and Experience 20.4.2** 時点の内容で作成されています。最新の UI とは異なっている場合があります。最新情報については、製品マニュアルをご参照ください
...
![SampleBanner.jpg](files/SampleBanner.jpg)
...
テーマに、新しいバナー画像（[SampleBanner.jpg](files/SampleBanner.jpg)）をアップロードします。
...
1. imgフォルダに、新しいバナー画像（[SampleBanner.jpg](files/SampleBanner.jpg)）をアップロードします
![image008.jpg](images/image008.jpg)


### 3.3 レイアウトファイルを編集する
アップロードした新しいバナー画像（[SampleBanner.jpg](files/SampleBanner.jpg)）を指定するように、レイアウトファイルを変更します
...
![image009.jpg](images/image009.jpg)
